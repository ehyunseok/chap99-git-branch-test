...
<head>
<meta charset="UTF-8">
<title>Spring MVC Mapping</title>
</head>
<body>
	...
	<button onclick='location.href="${pageContex.servletContext.contextPath}/menu/regist"'>GET 메뉴 등록 요청</button>
	...
	<button onclick='location.href="${pageContex.servletContext.contextPath}/menu/modify"'>GET 메뉴 수정 요청</button>
	...
	<button onclick='location.href="${pageContex.servletContext.contextPath}/menu/delete"'>GET 메뉴 삭제 요청</button>
	...
	<button onclick='location.href="${pageContext.servletContext.contextPath}/order/regist"'>GET 어쩌구저쩌구</button>
	...
	<button onclick='location.href="${pageContext.servletContext.contextPath}/order/detail/1000"'>GET 주문 상세보기 요청</button>
